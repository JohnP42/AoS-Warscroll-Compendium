...
function ColumnSet(columns, options) {
    ...
    if (Array.isArray(columns)) {
        var colNames = {};
        this.columns = $a.map(columns, function (c) {
    ...
    Object.defineProperty(this, 'names', {
        get: function () {
            if (!names) {
                names = $a.map(this.columns, function (c) {
    ...
    Object.defineProperty(this, 'variables', {
        get: function () {
            if (!variables) {
                variables = $a.map(this.columns, function (c) {
                    return c.variable;
                }).join();
            }
            return variables;
    ...
    Object.defineProperty(this, 'castVariables', {
        get: function () {
            if (!castVariables) {
                castVariables = $a.map(this.columns, function (c) {
    ...
    this.getUpdates = function (obj) {
        ...
        var dynamic;
        var list = $a.filter(this.columns, function (c) {
            if (c.cnd) {
                return false;
            }
            if (c.skip) {
    ...
    this.merge = function (columns) {
        ...
        var colNames = {}, cols = [];
        $a.forEach(this.columns, function (c, idx) {
            cols.push(c);
            colNames[c.name] = idx;
        });
        $a.forEach(cs.columns, function (c) {
    ...
    this.canUpdate = function (data) {
        ...
        if (Array.isArray(data)) {
            if (canSetMany === undefined) {
                cnd = $a.countIf(this.columns, function (c) {
                    return c.cnd;
                });
        ...
        $a.forEach(this.columns, function (c) {
            cnd += c.cnd ? 1 : 0;
            if (c.skip) {
